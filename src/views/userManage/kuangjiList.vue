<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="类型" width="120" sortable>
			</el-table-column>
			<el-table-column prop="age" label="产量/小时" width="100" sortable>
			</el-table-column>
			<el-table-column prop="age" label="运行小时" width="100" sortable>
			</el-table-column>
			<el-table-column prop="age" label="已领取" width="100" sortable>
			</el-table-column>
